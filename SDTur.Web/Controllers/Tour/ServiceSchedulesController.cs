...
namespace SDTur.Web.Controllers.Tour
{
    public class ServiceSchedulesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ServiceDate,ServiceTime,TourId,RegionId,IsActive")] CreateServiceScheduleViewModel createServiceScheduleViewModel)
        {
            if (ModelState.IsValid)
            {
                await _apiService.PostAsync<CreateServiceScheduleViewModel, ServiceScheduleViewModel>("api/serviceschedules", createServiceScheduleViewModel);
