...
namespace SDTur.Web.Controllers.Financial
{
    public class CashController : Controller
    {
        ...
        public async Task<IActionResult> Create(CreateCashViewModel createDto)
        {
            if (ModelState.IsValid)
            {
                var result = await _apiService.PostAsync<CreateCashViewModel, CashViewModel>("api/cash", createDto);
