...
namespace SDTur.Web.Controllers.System
{
    public class SystemLogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("LogLevel,Category,Action,Message,Details,IpAddress,UserAgent,UserId,EmployeeId")] CreateSystemLogViewModel createSystemLogViewModel)
        {
            if (ModelState.IsValid)
            {
                await _apiService.PostAsync<CreateSystemLogViewModel, SystemLogViewModel>("api/systemlogs", createSystemLogViewModel);
