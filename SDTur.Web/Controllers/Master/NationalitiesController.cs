...
namespace SDTur.Web.Controllers.Master
{
    public class NationalitiesController : Controller
    {
        ...
        public async Task<IActionResult> Edit(int id)
        {
            ...
            var updateDto = new UpdateNationalityViewModel
            {
                Id = nationality.Id,
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, UpdateNationalityViewModel updateDto)
        {
            if (id != updateDto.Id)
                return NotFound();
            ...
            if (ModelState.IsValid)
            {
                var result = await _apiService.PutAsync<UpdateNationalityViewModel, NationalityViewModel>($"api/nationalities/{id}", updateDto);
                if (result != null)
                    return RedirectToAction(nameof(Index));
            }
            return View(updateDto);
