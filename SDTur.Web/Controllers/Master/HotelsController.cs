...
namespace SDTur.Web.Controllers.Master
{
    public class HotelsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Address,Phone,RegionId,Order,IsActive")] CreateHotelViewModel createHotelViewModel)
        {
            if (ModelState.IsValid)
            {
                await _apiService.PostAsync<CreateHotelViewModel, HotelViewModel>("api/hotels", createHotelViewModel);
