...
namespace SDTur.Web.Controllers.Master
{
    public class EmployeesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("FirstName,LastName,Email,Phone,Position,Salary,CurrencyId,HireDate,CommissionRate,BranchId,IsActive")] CreateEmployeeViewModel createEmployeeViewModel)
        {
            if (ModelState.IsValid)
            {
                await _apiService.PostAsync<CreateEmployeeViewModel, EmployeeViewModel>("api/employees", createEmployeeViewModel);
